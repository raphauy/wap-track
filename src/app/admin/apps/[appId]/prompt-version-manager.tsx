...
import { updatePromptAction, updatePromptAndCreateVersionAction } from "../app-actions"
import PromptVersionList from './prompt-version-list'
import { deletePromptVersionAction } from "./promptversion-actions"
...
export default function PromptVersionManager({ appId, prompt, versions }: Props) {
        ...
        <div className="w-full flex flex-col h-full">
            ...
            <div className="flex gap-4 flex-grow min-h-[400px]">
                ...
                <div className="h-14 flex items-center justify-between px-2">
                    {selectedVersion && (
                        <>
                            <h2 className="text-lg font-semibold">{selectedVersion.user} - {format(selectedVersion.timestamp, "dd/MM/yyyy HH:mm:ss")}</h2>
